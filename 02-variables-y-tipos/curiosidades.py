mi_texto = '"Master"' #Al usar comillas de diferente tipo no interfieren
mi_texto2 = "en \"Python\"" # El \ hace que se ignore el caracter siguiente para que no cierre comillas
